    ...
    public PacientSymptomGUI(Covid19Pacient p) {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (weight >= 1 && weight <= 3) {
                        ...
                        Symptom addedSymptom = p.addSymptomByName(selectedSymptom.getName(), weight);
                        if (addedSymptom != null) {
                            errorLabel.setText("Symptom added: " + selectedSymptom.getName());
                        } else {
                            errorLabel.setText("ERROR, symptom does not exist: " + selectedSymptom.getName());
                        }
                    } else {
        ...
        btnRemoveSymptom.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                errorLabel.setText(" ");
                Symptom selectedSymptom = (Symptom) symptomComboBox.getSelectedItem();
                Symptom removedSymptom = p.removeSymptomByName(selectedSymptom.getName());
                if (removedSymptom != null) {
                    errorLabel.setText("Symptom removed: " + selectedSymptom.getName());
                } else {
                    errorLabel.setText("ERROR, symptom not found: " + selectedSymptom.getName());
                }
            }
        });
